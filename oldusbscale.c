...
static libusb_device* find_scale(libusb_device**); //Takes libusb device list (array of pointers) and find first usb device matching device listed in scale.h
...
int check_data(unsigned char* dat);
